  ...
  Future<void> _initSocket() async {
    try {
      ...
      if (ongoingOrder == null) {
        logger.w("BulkOrderMapScreen: No ongoing order found to track.");
        return;
      }

      final token = await SessionManager.getAuthToken();
      if (token == null || token.isEmpty) {
        logger.e("BulkOrderMapScreen: Auth token is missing.");
        return;
      }
      ...
      logger.i("BulkOrderMapScreen: Starting tracking for order ${ongoingOrder.uuId} at $wsUrl");
      ...
      logger.e("BulkOrderMapScreen: Error initializing socket: $e");
    }
  }
