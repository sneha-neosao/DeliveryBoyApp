...
class EditProfileTextField<T> extends StatefulWidget {
  final String label;
  ...
  @override
  State<EditProfileTextField<T>> createState() => _EditProfileTextFieldState<T>();
}

class _EditProfileTextFieldState<T> extends State<EditProfileTextField<T>> {
